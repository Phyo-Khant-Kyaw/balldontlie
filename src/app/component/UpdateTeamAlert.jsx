...
import { getTeamById, updateTeam } from "@/app/store/teamSlice";
...
export function UpdateTeamAlert({ id }) {
  const dispatch = useDispatch();
  const team = useSelector((state) => getTeamById(state, id));
